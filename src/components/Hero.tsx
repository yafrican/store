...
// //   return (
// //     <section className="bg-gradient-to-b from-gray-900 to-gray-800 py-8 hidden-mobile">
...
//   // Professional approach: Don't render anything on mobile devices
//   if (!isDesktop) {
//     return null
//   }
...
//   return (
//     <section className="bg-gradient-to-b from-gray-900 to-gray-800 py-8" role="banner" aria-label="Hero section with categories and promotions">
//       <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex flex-col lg:flex-row gap-8">
//           {/* Categories Sidebar - FIXED HEIGHT */}
//           <div className="lg:w-64 flex-shrink-0">
//             {/* Desktop Categories */}
//             <nav 
//               className="hidden lg:block bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 overflow-hidden h-auto max-h-[600px] overflow-y-auto"
...
//             {/* Trust Badges */}
//             <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4" role="complementary" aria-label="Trust badges">
//               <div className="bg-gray-800/50 rounded-xl p-4 text-center border border-gray-700 hover:border-yellow-500/30 transition-all duration-200">
...
export default function Hero() {
  ...
  return (
    <section className="bg-gradient-to-b from-gray-900 to-gray-800 py-4 lg:py-8" role="banner" aria-label="Hero section with categories and promotions">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
