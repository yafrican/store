...
//             {/* Right Actions - Mobile Sell/Dashboard Button */}
//             <div className="flex items-center space-x-2">
//               {/* Mobile Sell/Dashboard Button */}
//               {!isAdmin && (
//                 <Link
//                   href={isSeller ? "/seller/dashboard" : "/sell"}
//                   className="flex items-center gap-1 bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 text-gray-900 px-3 py-1.5 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border border-yellow-400 text-xs"
//                 >
//                   {isSeller ? (
//                     <>
...
//                   className="hidden md:flex items-center gap-1 xl:gap-2 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-3 xl:px-4 py-2 xl:py-2.5 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border border-green-400 text-sm"
//                 >
...
//               {/* Seller Dashboard Link in Mobile Menu */}
//               {isSeller && (
//                 <Link 
//                   href="/seller/dashboard" 
//                   onClick={() => setIsMenuOpen(false)} 
//                   className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl font-semibold transition-all duration-200 shadow-lg text-lg justify-center"
//                 >
